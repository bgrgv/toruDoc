...
class Index extends React.Component {
  state = {
    joinBtn: true,
    channel: this.props.location.state.new_id,
    baseMode: 'avc',
    transcode: 'interop',
    attendeeMode: 'video',
    videoProfile: '480p_4',
  ...
  componentDidMount() {
    ...
    // console.log(this.props.location.state.new_id)
  }
      ...
      <div className="wrapper index">
        ...
        <div className="ag-main">
          <section className="login-wrapper">
            <div className="login-header">
              ...
              <p className="login-title">DSC</p>
              <p className="login-subtitle">Helping for the better world</p>
            </div>
            <div className="login-body">
              {/* <div className="columns">
                <div className="column is-12">
                  <InputChannel placeholder="Input a room name here"></InputChannel>
                </div>
              </div> */}
              <div className="columns">
            ...
            <div className="login-footer">
              <a id="joinBtn"
                ...
                className="ag-rounded button">Join
                  </a>
            </div>
          </section>
        </div>
        <div className="ag-footer">
          <a className="ag-href" href="https://www.agora.io">
            <span>Powered By COVID-19</span>
          </a>
          <div>
            <span>Interested in DSC </span>
          </div>
        </div>
      </div>
    )
  ...
  constructor(props) {
    ...
    this._options = [
      ...
      },
      {
        label: 'Agora Live',
        value: 'al',
        content: 'real-time interactions '
      }
    ]
    this.state = {
      active: false,
